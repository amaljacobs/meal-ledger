...
| 2026-08-17 | Treat daily water, calorie, and protein goals as effective-dated historical records rather than a single retroactive preference. | A goal change must affect its effective date forward only, so past progress remains meaningful. |
| 2026-08-17 | Extend Summary with navigable week and calendar-based month views. | A fixed seven-day window is insufficient for reviewing prior spending, food intake, and hydration patterns. |
